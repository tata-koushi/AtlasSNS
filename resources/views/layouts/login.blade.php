<!--http://homestead.atlas/top　の表示画面-->
<!DOCTYPE html>
<html>
...
<body>
    <header>
        <div id="head">
            ...
            <div class="menu">
                <input type="checkbox" id="accordion-menu" class="accordion" />
                <label for="accordion-menu">〇〇さん<img src="images/icon1.png"></label>
                <ul id="accordion-links">
                    <li><a href="{{ url('/top') }}">HOME</a></li>
                    <li><a href="{{ url('/profile') }}">プロフィール編集</a></li>
                    <li><a href="{{ url('/login') }}">ログアウト</a></li>
                </ul>
            </div>
        </div>
    </header>
